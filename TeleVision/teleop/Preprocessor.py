...
from constants_vuer import grd_yup2grd_zup, hand2inspire, hand2Sim_right, hand2Sim_left
...
class VuerPreprocessor:
    ...
    def process_v2(self, tv):
        ...
        rel_left_wrist_mat = left_wrist_mat @ hand2Sim_left
        rel_right_wrist_mat = right_wrist_mat @ hand2Sim_right  # wTr = wTh @ hTr
