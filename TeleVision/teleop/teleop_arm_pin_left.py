...
class RosBridge(Node):
    ...
    def step(self, head_rmat, left_qpos, left_pose):
        msg_data = JointState()
        ...
        left_gripper_pose = left_qpos[self.gripper_index]

        order = [0, 2, 1, 3, 4, 5]
        values = [float(left_gripper_pose[i]) for i in order]
...
def main(args=None):
    ...
    try:
        ...
        while rclpy.ok():
            ...
            ros_bridge.step(head_rmat, left_qpos, left_pose)
