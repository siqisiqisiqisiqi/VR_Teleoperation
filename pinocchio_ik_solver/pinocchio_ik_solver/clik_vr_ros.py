...
class PoseIKController(Node):
    ...
    def joint_state_callback(self, msg):
        ...
        # print("Ordered names:", self.ordered_joint_names)
        # print("Received names:", name_list)
    ...
    def update_robot(self):
        ...
        # t1 = time.time()
        # self.get_logger().info(f"elapsed time is {t1-t0}.")
        # self.get_logger().info(f"publish the joint value {q_measured}")
